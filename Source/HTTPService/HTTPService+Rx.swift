...
extension HTTPService {
  ...
  func put(url: String, query: [String: CustomStringConvertible]? = nil, data: Data? = nil, headers: [String: CustomStringConvertible]? = nil) -> Observable<(Data, URLResponse)> {
    return Observable.create({ (observer) -> Disposable in
  ...
  func delete(url: String, query: [String: CustomStringConvertible]? = nil, headers: [String: CustomStringConvertible]? = nil) -> Observable<(Data, URLResponse)> {
    return Observable.create({ (observer) -> Disposable in
  ...
  private func notifyObserver(_ observer: AnyObserver<(Data, URLResponse)>) -> CompletionHandler {
